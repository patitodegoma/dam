...
public class Main {
	...
	public static void main(String[] args) {
		...
		double radio = 0, altura = 0, volumen = 0;	 // No tienen por qué llamarse igual que los atributos 
												     // pero como Eclipse autogenera código (por ejemplo
		                                             // los getters y setters) lo podemos poner. Además
