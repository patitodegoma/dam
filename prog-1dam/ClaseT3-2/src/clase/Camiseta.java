...
public class Camiseta {
	...
	public void mostrarInformacion () {
		...
		System.out.println("Descripción de la camiseta: "+this.descripcion);
		System.out.println("Código de color: "+this.codigoColor);
	}
	
		// Como estoy dentro de la clase, puedo utilizar los atributos directamente, sin necesidad de get y set,
	    // como convención del curso lo usamos con this.atributo. 
		
		// En las llamadas a métodos de la misma clase, usamos también el this. Ej: this.mostrarInformacion();
