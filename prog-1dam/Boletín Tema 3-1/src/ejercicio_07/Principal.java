...
public class Principal {
	...
	/*
	 ...
	 Tendremos que crear la clase ticket, la clase máquina y la clase principal o de prueba. 
	 ...
	 disponible un método que le ofrezca el saldo total de la recaudación de la máquina en ese día
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println("\t\t***Bienvenido a mi programa***\n"
				+ "Simula el funcionamiento de una máquina expendedora de tickets básica.");
