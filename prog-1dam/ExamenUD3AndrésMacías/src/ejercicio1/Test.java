...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\t\t***Bienvenido a mi programa***\n\n"
				+ "Gestiona una pastelería básica.");
		
		System.out.print("\nPor favor, indique el lado del cubo de la magdalena en mm: ");
		ladoMag = Leer.datoDouble();
		System.out.print("\nPor favor, indique el coste de fabricación de una magdalena: ");
		...
		do {
			...
			case 3:
				...
				System.out.printf("\nEl beneficio de la pastelería es de %.2f €", beneficio);
				break;
			case 4:
				System.out.printf("\nTenemos en la pastelería %d magdalenas.", miPasteleria.getTotalMagdalenas());
				break;
			case 5:
