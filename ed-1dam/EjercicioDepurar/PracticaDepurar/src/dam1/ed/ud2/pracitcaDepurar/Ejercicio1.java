 ...
 * lee el código y trata de comprenderlo por encima. A continuación, utiliza las
...
public class Ejercicio1 {
	...
	// TODO Pregunta 1: ¿Qué juego trata de implementar el programa?
	...
	public static void main(String[] args) {
		...
		// el nombre de las siguientes 3 variables por otros que te gusten más.
		// ¿Qué herramienta has utilizado?¿Cuál es su atajo de teclado?
		...
		while (!(ganaR && ganaB)) {
			...
			while (repetir) {
				System.out.println("El turno es de " + turno
						+ ". ¿En qué columna quiere introducir una ficha?");
				columna = Leer.datoInt() - 1;
				if (columna < 0 || columna > 6) {
					System.out.println("Introduzca una columna válida (entre 1 y 7)");
					repetir = true;
				...
				// TODO Pregunta 6: Completa el código anterior para que rechace
				// la
				// petición del usuario si la columna en la que se quiere
				// introducir la ficha está llena
				// TODO Respuesta 6:
			}
			...
			// TODO Pregunta 7: Ahora mismo el bucle es infinito. Añade aquí el
			// código necesario para que compruebe si en esta tirada hay un
			// ganador

			// Escribe aquí el código (este comentario hay que borrarlo)

			// TODO Fin del código introducido
			...
			// TODO Pregunta 3: ¿Para qué sirve la siguiente línea?
			// TODO Respuesta 3:
			turno = BLANCA.equals(turno) ? ROJA : BLANCA;

			// TODO Pregunta 4: Contesta esta pregunta ÚNICAMENTE TRAS LA
			// PRIMERA ITERACIÓN DEL BUCLE. ¿Cuál es el valor de la primera fila
			...
			// TODO Pregunta 5: ¿Es ésta la mejor forma de imprimir el tablero?
			// ¿Se corresponde con la forma visual a la que estamos
			// acostumbrados? Modifica el código para que se corresponda con el
